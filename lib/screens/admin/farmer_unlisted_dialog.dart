...
void showFarmerRequestDetails(BuildContext context, Map<dynamic, dynamic> request) {
  showDialog(
    context: context,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailSection('Crop Information', [
                      ...
                      _buildDetailRow(Icons.currency_rupee, 'Expected Price', '₹${request['expectedPrice'] ?? 'N/A'}/${request['unit'] ?? 'unit'}'),
